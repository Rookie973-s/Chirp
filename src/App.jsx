...
export default function App() {
  ...
  boxShadow: "0 4px 24px rgba(0,0,0,.25), 0 1px 0 rgba(212,175,55,.08) inset",
  ...
  <img
    ...
    alt="ATBUConnect"
    style={{
      height: 36,        // adjust this number up/down to fit
      width: 36,         // keep this the same as height for proper aspect ratio
      objectFit: "contain",
      borderRadius: '50%',
    }}
  />
            ...
            <button className="ib" title="Notifications"
              ...
              {unread > 0 && (
                <span style={{
                  ...
                  background: T.gold, borderRadius: "50%", border: "2px solid #000B18",
                }} />
              )}
            </button>
            {notifOpen && (
      ...
      <main className="app-main" style={{ flex: 1, paddingBottom: 72, paddingLeft: 5, paddingRight: 5 }}>
        <Routes>
