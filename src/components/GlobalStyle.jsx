const GlobalStyle = () => (
  <style>{`
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .btn-gold{background:linear-gradient(135deg,#D4AF37,#b89228);color:#061220;border:none}
    .btn-gold:hover{box-shadow:0 6px 20px rgba(212,175,55,.35);transform:translateY(-2px)}
    ...
    @media(max-width:700px){
      .app-topbar{height:56px !important}
    ...
    .auth-toggle-box{position:absolute;width:100%;height:100%;overflow:hidden;z-index:2}
    ...
    @media(max-width:650px){
      ...
      /* Form panel sits at the bottom 64% */
      .auth-form-panel{
        width:100%;height:65%;
      ...
      /* Toggle overlay: slides vertically */
      .auth-toggle-box::before{
