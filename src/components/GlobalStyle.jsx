...
@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,600;0,700;1,600&family=DM+Sans:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Orbitron:wght@700&family=Montserrat:wght@700;800&display=swap');
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .light{--bg:#F8FAFC;--surf:#FFFFFF;--surfH:#F1F5F9;--surfA:#F3F6F9;--txt:#0F172A;--mut:#475569;--faint:#111111;--brd:#E2E8F0;--brdS:#000814}
    .dark{--bg:#000814;--surf:#111111;--surfH:#1A2639;--surfA:#0D1420;--txt:#ffffff;--mut:#94A3B8;--faint:#475569;--brd:#1E293B;--brdS:#334155}
    ...
    .home-hero-bg{
      ...
      pointer-events:none;transform:scale(1.01);
      opacity:.36;filter:saturate(1.08) contrast(1.06);
    }
    .home-hero-overlay{
      position:absolute;inset:0;z-index:-1;pointer-events:none;
      background:
        radial-gradient(ellipse at 50% 0%,rgba(59,130,246,.16) 0%,transparent 58%),
        linear-gradient(180deg,rgba(0,8,20,.22),rgba(0,8,20,.14));
    }
    .light .home-hero-bg{
      opacity:.62;filter:saturate(1.16) contrast(1.12);
    }
    .light .home-hero-overlay{
      background:
        radial-gradient(ellipse at 50% 0%,rgba(59,130,246,.12) 0%,transparent 58%),
        linear-gradient(180deg,rgba(248,250,252,.38),rgba(248,250,252,.26));
    }
