...
@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,600;0,700;1,600&family=DM+Sans:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Orbitron:wght@700&family=Montserrat:wght@700;800&display=swap');
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .light{--bg:#F8FAFC;--surf:#FFFFFF;--surfH:#F1F5F9;--surfA:#F3F6F9;--txt:#0F172A;--mut:#475569;--faint:#111111;--brd:#1E293B;--brdS:#000814}
    .dark{--bg:#000814;--surf:#111111;--surfH:#1A2639;--surfA:#0D1420;--txt:#ffffff;--mut:#94A3B8;--faint:#475569;--brd:#3F3F46;--brdS:#334155}
