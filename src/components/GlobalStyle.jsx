const GlobalStyle = () => (
  <style>{`
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .dark{--bg:#000814;--surf:#000000;--surfH:#1A2639;--surfA:#0D1420;--txt:#F1F5F9;--mut:#94A3B8;--faint:#475569;--brd:#1E293B;--brdS:#334155}
    ...
    .app-topbar { height: 48px !important; }
.app-main   { padding-top: 58px; }

@media(max-width:700px) {
  .app-topbar { height: 50px !important; }
  .app-main   { padding-top: 50px; }
}
