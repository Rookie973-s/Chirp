  ...
  return (
    <div className="sch-drop" style={{background:"#121B2B",color:"#fff"}}>
        ...
        <>
          ...
          {qHits.map(q=>(
            <button key={q.id} onClick={()=>{onNavigate(q);onClose();}}
              ...
              </span><meta http-equiv="X-UA-Compatible" content="IE=7" />
              <div>
      ...
      <div style={{padding:"10px 16px",borderTop:"1px solid rgba(255,255,255,.07)"}}>
        <button onClick={onClose} style={{fontSize:12,color:"rgba(212,175,55,.8)",fontWeight:600,background:"none",border:"none",cursor:"pointer"}}>
