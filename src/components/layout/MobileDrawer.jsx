          ...
          <div style={{display:"flex",alignItems:"center",gap:10}}>
            <div style={{width:38,height:38,borderRadius:10,background:"linear-gradient(135deg,#3B82F6,#2563EB)",display:"flex",alignItems:"center",justifyContent:"center"}}>
              <svg width="22" height="22" viewBox="0 0 40 40" fill="none">
                <path d="M20 7L26 13H22V20H18V13H14L20 7Z" fill="#000B18"/>
                <path d="M12 21H28V23C28 27.418 24.418 31 20 31C15.582 31 12 27.418 12 23V21Z" fill="#000B18"/>
        ...
        <div style={{flex:1,overflowY:"auto",padding:"8px 0"}}>
          {navItems.map(({ic,l,p})=>(
            <button key={p}
              ...
              <span style={{width:34,height:34,borderRadius:9,background:page===p?"rgba(59,130,246,.14)":"var(--surfA)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
