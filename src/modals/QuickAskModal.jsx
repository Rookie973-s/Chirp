  ...
  return (
    <Modal onClose={onClose} maxW={520}>
      <div style={{background:`linear-gradient(135deg,${T.navy},${T.navyL})`,padding:"22px 24px",color:"#fff",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{position:"absolute",right:-20,top:-30,width:120,height:120,background:"radial-gradient(circle,rgba(212,175,55,.2),transparent 70%)"}}/>
      ...
      <div style={{padding:24,display:"flex",flexDirection:"column",gap:14}}>
        ...
        <div style={{display:"flex",gap:10,justifyContent:"flex-end",marginTop:4}}>
          ...
          <button className="btn btn-pri" onClick={submit}><Ic n="send" s={15} c="#061220"/>Post Question</button>
        </div>
      </div>
    </Modal>
  );
