...
function ApplyPage({toast}) {
  ...
  return (
    <div style={{maxWidth:640,margin:"0 auto"}}  className="apply-wrap">
      <div className="fu" style={{marginBottom:28,textAlign:"center"}}>
        <div style={{display:"inline-flex",alignItems:"center",justifyContent:"center",width:56,height:56,background:"rgba(59,130,246,.15)",borderRadius:16,marginBottom:16}}><Ic n="cap" s={26} c={T.gold}/></div>
      ...
      <div className="apply-border-wrap fu fu2">
        ...
        {step===3&&(
          <div style={{animation:"fadeUp .35s ease"}}>
            ...
            <div style={{padding:14,background:"rgba(59,130,246,.1)",borderRadius:12,marginTop:18,border:"1px solid rgba(59,130,246,.3)"}}>
        ...
        <div style={{display:"flex",justifyContent:"space-between",marginTop:28,gap:12}}>
          ...
          {step<3?(
            ...
            <button className="btn btn-pri" onClick={submit}><Ic n="check" s={15} c="#000B18"/>Submit Application</button>
          )}
        </div>
