...
function HomePage({onNav}) {
  ...
  <div style={{position:"absolute",inset:0,background:`radial-gradient(ellipse at 50% 0%,rgba(59,130,246,.12) 0%,transparent 60%)`,pointerEvents:"none"}}/>
        <div style={{display:"inline-flex",alignItems:"center",gap:8,padding:"6px 16px",borderRadius:20,background:"rgba(59,130,246,.12)",border:"1px solid rgba(59,130,246,.25)",marginBottom:20,fontSize:13,fontWeight:600,color:T.gold}}>
