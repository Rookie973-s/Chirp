  ...
  return (
    <div style={{maxWidth:760,margin:"0 auto"}}>
          ...
          <div style={{display:"flex",gap:12,marginBottom:14,alignItems:"center"}}>
            ...
            <div>
              <div style={{fontWeight:600,fontSize:14,display:"flex",alignItems:"center",gap:6}}>
                {a.user}
                {a.staff&&<span style={{background:"rgba(59,130,246,.15)",color:T.gold,fontSize:10,fontWeight:700,padding:"2px 8px",borderRadius:6,textTransform:"uppercase",letterSpacing:.5}}>Staff</span>}
              </div>
      ...
      <div className="card" style={{padding:22,marginTop:20}}>
        ...
        <button className="btn btn-pri" onClick={postReply}><Ic n="send" s={15} c="#000B18"/>Post Answer</button>
      </div>
    </div>
  );
}
