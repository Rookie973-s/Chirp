...
function StaffPage({user,onLogin,toast}) {
  ...
  return (
    <div style={{flex:1,minWidth:0}}>
      ...
      <div style={{display:"flex",gap:12,marginBottom:22,alignItems:"center",flexWrap:"wrap"}} className="fu fu1">
      ...
      {selected&&(
        <Modal onClose={()=>setSelected(null)} maxW={520}>
          <div style={{background:`linear-gradient(135deg,${T.navy},${T.navyL})`,padding:"32px 28px 24px",position:"relative",color:"#fff"}}>
            ...
            <div style={{display:"flex",gap:18,alignItems:"center"}}>
              <div style={{position:"relative",flexShrink:0}}>
                ...
                {selected.online&&<div style={{position:"absolute",bottom:3,right:3,width:14,height:14,background:"#10B981",borderRadius:"50%",border:"2px solid #1A365D"}}/>}
              </div>
              <div>
            ...
            {msgOpen?(
              <div style={{animation:"slideDown .3s ease"}}>
                ...
                <div style={{display:"flex",gap:10}}>
                  <button className="btn btn-pri" style={{flex:1}} onClick={sendMsg}><Ic n="send" s={15} c="#061220"/>Send Message</button>
